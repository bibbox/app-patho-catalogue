...
@Component({
  ...
  templateUrl: './scan-search-result-list-submission-element.component.html'
})

/**
 * The component for displaying a list element for an item search result of the type Scan
 */
export class ScanSearchResultListSubmissionElementComponent extends SearchResultListElementComponent<ItemSearchResult, Item> implements OnInit {
  ...
  ngOnInit() {
    super.ngOnInit();
    const defaultValue = this.firstMetadataValue('scan.familyName') + ', ' + this.firstMetadataValue('scan.givenName');
