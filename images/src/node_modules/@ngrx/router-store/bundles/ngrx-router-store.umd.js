(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@ngrx/store'),require('@angular/router'),exports, require('@ngrx/store'), require('@angular/core'), require('@angular/router'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@ngrx/router-store', ['@angular/core','@ngrx/store','@angular/router','exports', '@ngrx/store', '@angular/core', '@angular/router', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,global.ngrx.store,global.ng.router,(global.ngrx = global.ngrx || {}, global.ngrx['router-store'] = {}), global.ngrx.store, global.ng.core, global.ng.router, global.rxjs.operators));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, store, core, router, operators) { 'use strict';
