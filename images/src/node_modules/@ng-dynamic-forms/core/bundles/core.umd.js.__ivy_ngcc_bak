(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('reflect-metadata'), require('rxjs/operators'), require('@angular/forms'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@ng-dynamic-forms/core', ['exports', '@angular/core', 'rxjs', 'reflect-metadata', 'rxjs/operators', '@angular/forms', '@angular/common'], factory) :
    (global = global || self, factory((global.ngDynamicForms = global.ngDynamicForms || {}, global.ngDynamicForms.core = {}), global.ng.core, global.rxjs, null, global.rxjs.operators, global.ng.forms, global.ng.common));
}(this, (function (exports, i0, rxjs, reflectMetadata, operators, i1, common) { 'use strict';
