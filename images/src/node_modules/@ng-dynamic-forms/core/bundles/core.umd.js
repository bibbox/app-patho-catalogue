(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/forms'),exports, require('@angular/core'), require('rxjs'), require('reflect-metadata'), require('rxjs/operators'), require('@angular/forms'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@ng-dynamic-forms/core', ['@angular/core','@angular/common','@angular/forms','exports', '@angular/core', 'rxjs', 'reflect-metadata', 'rxjs/operators', '@angular/forms', '@angular/common'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.ng.forms,(global.ngDynamicForms = global.ngDynamicForms || {}, global.ngDynamicForms.core = {}), global.ng.core, global.rxjs, null, global.rxjs.operators, global.ng.forms, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, i0, rxjs, reflectMetadata, operators, i1, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DynamicFormArrayComponent = /** @class */ (function (_super) {
        ...
        DynamicFormArrayComponent.prototype.markForCheck = function () {
            if (this.components instanceof i0.QueryList) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DynamicFormComponent, [{
    ...
    })(exports.DynamicFormControlEventType || (exports.DynamicFormControlEventType = {}));
    ...
    var DynamicFormValueControlModel = /** @class */ (function (_super) {
        ...
        function DynamicFormValueControlModel(config, layout) {
            var _this = this;
            var _a, _b, _c;
            _this = _super.call(this, config, layout) || this;
            ...
            _this.value$ = new rxjs.BehaviorSubject((_c = config.value) !== null && _c !== void 0 ? _c : null);
    ...
    var DynamicFormArrayModel = /** @class */ (function (_super) {
        ...
        DynamicFormArrayModel.prototype.moveGroup = function (index, step) {
            var _c;
            (_c = this.groups).splice.apply(_c, __spread([index + step, 0], this.groups.splice(index, 1)));
            this.updateGroupIndex();
        };
        ...
        Object.defineProperty(DynamicInputModel.prototype, "list", {
            set: function (list) {
                ...
                if (Array.isArray(list)) {
                    ...
                    this.list$ = list.pipe(operators.tap(function (list) { return _this._list = list; }));
                }
                else {
                    this._list = null;
                    this.list$ = null;
    ...
    })(exports.DYNAMIC_TEMPLATE_DIRECTIVE_ALIGNMENT || (exports.DYNAMIC_TEMPLATE_DIRECTIVE_ALIGNMENT = {}));
    var DynamicTemplateDirective = /** @class */ (function () {
        function DynamicTemplateDirective(templateRef) {
            this.templateRef = templateRef;
            this.align = exports.DYNAMIC_TEMPLATE_DIRECTIVE_ALIGNMENT.End;
            this.as = null;
        }
    ...
    var DynamicFormLayoutService = /** @class */ (function () {
        ...
        */
        DynamicFormLayoutService.prototype.getStartTemplate = function (model, templates) {
            return this.getAlignedTemplate(model, templates, exports.DYNAMIC_TEMPLATE_DIRECTIVE_ALIGNMENT.Start);
        };
        DynamicFormLayoutService.prototype.getEndTemplate = function (model, templates) {
            return this.getAlignedTemplate(model, templates, exports.DYNAMIC_TEMPLATE_DIRECTIVE_ALIGNMENT.End);
        };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DynamicFormLayoutService, [{
    ...
    })(exports.DynamicFormHook || (exports.DynamicFormHook = {}));
    ...
    var CHANGE_ERROR_STATE_MATCHER = function (control, model, hasFocus) {
        return (model.updateOn === exports.DynamicFormHook.Change || model.updateOn === null) ? control.dirty : control.touched && !hasFocus;
    };
    var DYNAMIC_ERROR_MESSAGES_MATCHER = new i0.InjectionToken("DYNAMIC_ERROR_MESSAGES_MATCHER");
    ...
    var DynamicFormValidationService = /** @class */ (function () {
        ...
        DynamicFormValidationService.prototype.getValidatorFn = function (validatorName, validatorArgs, validatorsToken) {
            ...
            if (i1.Validators.hasOwnProperty(validatorName)) { // Built-in Angular Validators
                validatorFn = i1.Validators[validatorName];
            }
        ...
        DynamicFormValidationService.prototype.isFormHook = function (value) {
            return isString(value) && Object.values(exports.DynamicFormHook).includes(value);
        };
...
DynamicFormValidationService.ɵfac = function DynamicFormValidationService_Factory(t) { return new (t || DynamicFormValidationService)(ɵngcc0.ɵɵinject(i1.NG_VALIDATORS, 8), ɵngcc0.ɵɵinject(i1.NG_ASYNC_VALIDATORS, 8), ɵngcc0.ɵɵinject(DYNAMIC_VALIDATORS, 8), ɵngcc0.ɵɵinject(DYNAMIC_ERROR_MESSAGES_MATCHER, 8)); };
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DynamicFormValidationService, [{
    ...
    DynamicFormValidationService.ɵprov = i0.ɵɵdefineInjectable({ factory: function DynamicFormValidationService_Factory() { return new DynamicFormValidationService(i0.ɵɵinject(i1.NG_VALIDATORS, 8), i0.ɵɵinject(i1.NG_ASYNC_VALIDATORS, 8), i0.ɵɵinject(DYNAMIC_VALIDATORS, 8), i0.ɵɵinject(DYNAMIC_ERROR_MESSAGES_MATCHER, 8)); }, token: DynamicFormValidationService, providedIn: "root" });
    DynamicFormValidationService.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [DYNAMIC_ERROR_MESSAGES_MATCHER,] }] }
    ]; };
    ...
    var DynamicFormGroupModel = /** @class */ (function (_super) {
        ...
        DynamicFormGroupModel.prototype.move = function (index, step) {
            var _b;
            (_b = this.group).splice.apply(_b, __spread([index + step, 0], this.group.splice(index, 1)));
        };
        ...
        Object.defineProperty(DynamicOptionControlModel.prototype, "options", {
            ...
            set: function (options) {
                ...
                if (Array.isArray(options)) {
                    ...
                    this.options$ = options.pipe(operators.map(function (optionsConfig) {
    ...
    var DynamicFormService = /** @class */ (function () {
        ...
        DynamicFormService.prototype.createAbstractControlOptions = function (validatorsConfig, asyncValidatorsConfig, updateOn) {
            ...
            return {
                ...
                updateOn: updateOn !== null && this.validationService.isFormHook(updateOn) ? updateOn : exports.DynamicFormHook.Change
            };
        };
        ...
        DynamicFormService.prototype.findById = function (id, formModel) {
            ...
            var findByIdFn = function (modelId, groupModel) {
                ...
                try {
                    ...
                    try {
                        if (groupModel_1_1 && !groupModel_1_1.done && (_b = groupModel_1.return)) _b.call(groupModel_1);
                    }
                    finally { if (e_1) throw e_1.error; }
                }
            };
        ...
        DynamicFormService.prototype.detectChanges = function (formComponent) {
            ...
            if (formComponent instanceof DynamicFormComponent) {
                ...
                try {
                    for (var _c = __values(this.componentService.getForms()), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var form = _d.value;
                        form.markForCheck();
                        form.detectChanges();
                    }
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DynamicFormService, [{
    ...
    DynamicFormService.ɵprov = i0.ɵɵdefineInjectable({ factory: function DynamicFormService_Factory() { return new DynamicFormService(i0.ɵɵinject(DynamicFormComponentService), i0.ɵɵinject(DynamicFormValidationService)); }, token: DynamicFormService, providedIn: "root" });
    ...
    var OR_OPERATOR = "OR";
    var DYNAMIC_MATCHERS = new i0.InjectionToken("DYNAMIC_MATCHERS");
    ...
    var DynamicFormRelationService = /** @class */ (function () {
        ...
        DynamicFormRelationService.prototype.getRelatedFormControls = function (model, group) {
            var conditionReducer = function (controls, condition) {
                ...
                if (!controls.hasOwnProperty(path)) {
                    ...
                    control instanceof i1.FormControl ? controls[path] = control : console.warn("No related form control with id " + condition.id + " could be found");
                }
                return controls;
            };
        ...
        DynamicFormRelationService.prototype.subscribeRelations = function (model, group, control) {
            ...
            Object.values(relatedFormControls).forEach(function (relatedControl) {
                ...
                subscriptions.push(rxjs.merge(valueChanges, statusChanges).subscribe(function () {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DynamicFormRelationService, [{
    ...
    DynamicFormRelationService.ɵprov = i0.ɵɵdefineInjectable({ factory: function DynamicFormRelationService_Factory() { return new DynamicFormRelationService(i0.ɵɵinject(DYNAMIC_MATCHERS, 8), i0.ɵɵinject(i0.INJECTOR)); }, token: DynamicFormRelationService, providedIn: "root" });
    DynamicFormRelationService.ctorParameters = function () { return [
        { type: Array, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [DYNAMIC_MATCHERS,] }] },
        { type: i0.Injector }
    ]; };
    ...
    var DynamicFormControlContainerComponent = /** @class */ (function () {
        ...
        DynamicFormControlContainerComponent.prototype.onGroupOrModelChange = function () {
            ...
            if (this.model) {
                ...
                if (this.model.relations.length > 0) {
                    (_b = this.subscriptions).push.apply(_b, __spread(this.relationService.subscribeRelations(this.model, this.group, this.control)));
                }
            }
        };
        DynamicFormControlContainerComponent.prototype.onChange = function ($event) {
            ...
            if ($event instanceof Event) { // native HTML5 change event
                ...
                this.change.emit(this.createDynamicFormControlEvent($event, exports.DynamicFormControlEventType.Change));
            }
        ...
        DynamicFormControlContainerComponent.prototype.onBlur = function ($event) {
            if (isDynamicFormControlEvent($event)) { // event bypass
                ...
                this._hasFocus = false;
                this.blur.emit(this.createDynamicFormControlEvent($event, exports.DynamicFormControlEventType.Blur));
            }
        };
        DynamicFormControlContainerComponent.prototype.onFocus = function ($event) {
            if (isDynamicFormControlEvent($event)) { // event bypass
                ...
                this._hasFocus = true;
                this.focus.emit(this.createDynamicFormControlEvent($event, exports.DynamicFormControlEventType.Focus));
            }
        };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DynamicFormControlContainerComponent, [{
        type: i0.Directive
    ...
    DynamicFormControlContainerComponent.ctorParameters = function () { return [
        { type: i0.ChangeDetectorRef },
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DynamicFormControlWithTemplateComponent, [{
    ...
    DynamicFormControlWithTemplateComponent.ctorParameters = function () { return [
        { type: DynamicFormLayoutService },
        { type: DynamicFormValidationService }
    ]; };
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DynamicFormsCoreModule, { declarations: [DynamicListDirective, DynamicTemplateDirective], imports: [ɵngcc1.CommonModule, ɵngcc2.ReactiveFormsModule], exports: [DynamicListDirective, DynamicTemplateDirective] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DynamicFormsCoreModule, [{
    ...
    exports.CHANGE_ERROR_STATE_MATCHER = CHANGE_ERROR_STATE_MATCHER;
    exports.DEFAULT_ERROR_STATE_MATCHER = DEFAULT_ERROR_STATE_MATCHER;
    exports.DISABLED_MATCHER = DISABLED_MATCHER;
    exports.DISABLED_MATCHER_PROVIDER = DISABLED_MATCHER_PROVIDER;
    exports.DYNAMIC_ERROR_MESSAGES_MATCHER = DYNAMIC_ERROR_MESSAGES_MATCHER;
    ...
    exports.DynamicFormControlWithTemplateComponent = DynamicFormControlWithTemplateComponent;
    ...
    exports.HIDDEN_MATCHER_PROVIDER = HIDDEN_MATCHER_PROVIDER;
    ...
    exports.REQUIRED_MATCHER_PROVIDER = REQUIRED_MATCHER_PROVIDER;
